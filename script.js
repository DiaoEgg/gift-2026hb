    ...
    const quizQuestions = [
        {
            ...
            memory: `<p>高一下学期，我们在七班成了同班同学。</p>
                     <p>说实话，第一次有交集是什么时候，我已经记不太清了。但我记得有一次玩"国王与天使"的游戏，<span class="highlight">你是我的天使</span>。</p>
                     <p>也许，就是从那时候开始，我们慢慢有了交集吧。</p>`
        },
        {
            question: "那时候早自习查校服很严，你曾经帮过我什么？",
            options: ["帮我望风", "借我外套", "帮我找借口", "没帮过"],
            correct: 1,  // 借我外套
            icon: "🧥",
            memory: `<p>那时候上早自习，查校服查得严。</p>
                     <p>有时候我又忘了穿，你就会<span class="highlight">悄悄把你的外套递给我</span>。</p>
                     <p>那种被照顾的感觉，现在想起来还是很温暖。</p>`
        },
        {
            question: "中秋前后那次班会，大家一起做手工，你送了我什么？",
            options: ["一张贺卡", "手工月饼", "一颗糖", "没送过"],
            correct: 1,  // 手工月饼
            icon: "🥮",
            memory: `<p>印象最深的是有一次班会，恰好在中秋前后，班主任给大家过集体生日，带着我们做手工月饼。</p>
                     <p>你做了一个，<span class="highlight">送给了我</span>。</p>
                     <p>我还记得当时自己特别害羞，接过来就一口闷了。那会的我们，都好单纯啊。</p>`
        },
        {
            question: "后来那个少年把你QQ删了，说什么时候再加回来？",
            options: ["等放假的时候", "等考上大学", "等考进重点班", "等毕业以后"],
            correct: 2,  // 等考进重点班
            icon: "💬",
            memory: `<p>曾经意气风发的少年，突然有一天晚上，把你的QQ删了。</p>
                     <p>还信誓旦旦地说：<span class="highlight">"等我考进重点班，再把你加回来。"</span></p>
                     <p>可后来，他也没能做到...</p>`
        }
    ];
